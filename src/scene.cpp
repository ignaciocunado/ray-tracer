...
Scene loadScenePrebuilt(SceneType type, const std::filesystem::path& dataDir)
{
    ...
    case Custom: {
        ...
        scene.lights.emplace_back(PointLight { glm::vec3(0.0f, 15.0f, 0.0f), glm::vec3(1) });
        scene.lights.emplace_back(PointLight { glm::vec3(3.0f, 15.0f, 0.0f), glm::vec3(1) });
        scene.lights.emplace_back(PointLight { glm::vec3(6.0f, 15.0f, 0.0f), glm::vec3(1) });
    } break;
    };
